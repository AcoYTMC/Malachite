...
public class MalachiteClusterBlock extends Block implements Waterloggable {
    public static final MapCodec<MalachiteClusterBlock> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(
                    ...
                    .apply(instance, MalachiteClusterBlock::new)
    );
    ...
    public MalachiteClusterBlock(float height, float xzOffset, AbstractBlock.Settings settings) {
        super(settings);
