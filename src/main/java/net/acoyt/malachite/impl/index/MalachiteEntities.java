...
import net.acoyt.malachite.impl.client.render.entity.EnergyBeamEntityRenderer;
import net.acoyt.malachite.impl.client.render.entity.MalachiteDaggerEntityRenderer;
